...
<div
       ...
       <Link to="/"> <p className='text-white text-xl p-4 w-full  text-center'>HOME</p></Link>
        ...
        <div className="flex w-full items-center justify-evenly md:justify-start">
          <Link to ="/">
          <p
           ...
           <div
            style={{ float: "right", marginLeft: "40%" }}
      ...
      <div
        ...
        <div className=' w-full md:w-5/6 border-2 border-blue-100 m-auto shadow-lg px-4 py-10 bg-white'>
          ...
          <p className='reachout border-2 flex justify-center items-center mt-8 mx-4 font-bold border-blue-300 md:p-4 h-16  w-4/5 md:w-2/5 m-4 text-green-300 text-xl  hover:text-white ease-linear duration-300'>
            Send Message &nbsp;{" "}
            <svg
