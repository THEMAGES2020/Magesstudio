  ...
  return (
    <div
      ...
      <div>
        ...
        <span className='reachout m-auto md:m-0 flex my-4 md:mt-44  p-4 border-2 w-64 justify-center items-center group  hover:text-white ease-in-out duration-300 ' style={{borderColor:"#44b2e5"}}>
          <Link to='/contact'>
            <p
              className='reachouttext   mr-2  font-bold   text-blue-400 group-hover:text-white'
              style={{ color: "" }}>
              REACH OUT TO US
            </p>
          </Link>
      ...
      <div
        ...
        <a href='https://wa.me/+916238023468'>
          <p className='text-xl md:text-2xl text-center m-2 md:m-0  hover:text-blue-300 text-gray-400'>
            Click <span className='font-bold text-blue-400' style={{color:"#44b2e5"}}>here</span> to
            Whatsapp us
          </p>
        </a>
        {/* <a href='mailto:Hello@mages.studio'> */}
          ...
          <a href='mailto:themages2020@gmail.com' className=''>
            {" "}
        ...
        <div
          ...
          <a href='https://instagram.com/magesstudio'>
            ...
            <svg
              ...
              height='16'
              fill='currentColor'
              className='w-16 sociallogo1   bi bi-instagram hover:text-white'
              viewBox='0 0 16 16'>
