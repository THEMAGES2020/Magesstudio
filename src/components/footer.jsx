  ...
  return (
    <div
      ...
      <div>
        ...
        <span className='reachout m-auto md:m-0 flex my-4 md:mt-44  p-4 border-2 border-blue-400  w-64 justify-center items-center group  hover:text-white ease-in-out duration-300 '>
          <Link to='/contact'>
            <p
              className='mr-2  font-bold   text-blue-400 group-hover:text-white'
              style={{ color: "" }}>
              REACH OUT TO US
            </p>
          </Link>
